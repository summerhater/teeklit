...
>
> - 앱 '티클릿'의 주요기능인 '반복 티클 생성'을 구현하는 과정에서 뷰모델이 너무 커지는 문제를 마주했습니다 **(ViewModel 비대화)**.
> - 이를 해결하고자 다트(Dart) 언어의 믹스인(Mixin) 기능을 활용해, 각자가 맡은 역할을 명확히 나누는 **역할 분리**(Separation of Concerns) 전략을 세웠습니다.
