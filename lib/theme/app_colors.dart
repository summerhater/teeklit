...
class AppColors {
  ...
  // 메인 컬러 - 그린 계열
  static const DarkGreen = Color(0xFF97A985);
  static const LightGreen = Color(0xFFCCDBBB);
  static const Green = Color(0xFFB1C39F);

  // 서브 컬러
  static const Pink = Color(0xFFF6CFCF);
  static const Blue = Color(0xFFC5D3E8);
  static const Orange = Color(0xFFF1A04B);
  static const Ivory = Color(0xFFFFFDEC);
}

//colors.dart 앱 컬러 설정 파일 입니다.
//AppColors.Green 이런 식으로 꺼내쓰면 됩니다!